...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_power_mode -prefix
//               fifo_power_mode_ fifo_acquisition_stub.v
...
module fifo_power_mode(clk, srst, din, wr_en, rd_en, prog_empty_thresh, 
